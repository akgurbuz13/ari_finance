package com.ari.platform.payments.api
...
import com.ari.platform.payments.internal.service.CrossBorderTransferService
    ...
    fun initiateCrossBorderTransfer(
        ...
        val order = if (senderAccount.currency == receiverAccount.currency) {
            ...
            sameCurrencyCrossBorderService.execute(
                ...
                receiverAccountId = request.receiverAccountId,
                amount = request.amount
                    ?: throw com.ari.platform.shared.exception.BadRequestException("Amount required for same-currency cross-border"),
                description = request.description,
                initiatorId = userId
            )
        } else {
            ...
            crossBorderTransferService.execute(
                ...
                fxQuoteId = request.fxQuoteId
                    ?: throw com.ari.platform.shared.exception.BadRequestException("FX quote required for cross-currency transfer"),
                description = request.description,
                initiatorId = userId
            )
        }
