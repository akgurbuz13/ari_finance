...
import com.ova.platform.payments.internal.repository.RailReconciliation
...
import com.ova.platform.payments.internal.repository.SafeguardingBalance
...
class ReconciliationService(
    ...
    private fun getBankName(region: String): String {
        return when (region) {
            "TR" -> "Ova Safeguarding - Turkiye"
            "EU" -> "Ova Safeguarding - Lithuania"
            else -> "Ova Safeguarding"
        }
    }
}
