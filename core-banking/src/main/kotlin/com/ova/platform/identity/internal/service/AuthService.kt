...
import com.ova.platform.shared.exception.UnauthorizedException
import com.ova.platform.shared.security.AuditService
import com.ova.platform.shared.security.JwtTokenProvider
...
class AuthService(
    ...
    fun setupTotp(userId: UUID): TotpSetup {
        ...
        return TotpSetup(
            secret = secret,
            uri = "otpauth://totp/Ova:${user.email}?secret=$secret&issuer=Ova"
        )
    }
