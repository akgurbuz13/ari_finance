...
class NotificationService(
    ...
    fun notifyKycApproved(userId: UUID) {
        ...
        emailService.send(user.email, "KYC Approved", "Your identity verification has been approved. You can now use all Ova features.")
    ...
    fun sendOtp(userId: UUID, otp: String) {
        ...
        smsService.send(user.phone, "Your Ova verification code is: $otp")
    }
}
